...
if __name__=='__main__':
    ...
    train_composed = transforms.Compose([Resize(accountant.image_size), ToTensor(), T.RandAugment(num_ops = 6)])
    val_composed = transforms.Compose([Resize(accountant.image_size), ToTensor()])
    
    ds_train = ImagesRotateDS(train_composed, multiplier=3)
    ds_val = ImagesRotateDS(val_composed, multiplier=1)
